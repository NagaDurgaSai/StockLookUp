...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private const val API_KEY = "RA5UQQYXCEBJGTXG"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Matching the id's from XML file
        stockPriceTextView = findViewById(R.id.stockPriceText)
        ...
        val request = JsonObjectRequest(Request.Method.GET, apiUrl, null,
            { response ->
                try {
                    ...
                    // Fetching company details after fetching stock price
